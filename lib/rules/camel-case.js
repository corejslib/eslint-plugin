...
export default {
    ...
    create ( context ) {
        ...
        function isUnderscored ( name ) {
            ...
            if ( options.strictCamelCase && /[A-Z]{2}/v.test( name ) && !RESERVED.has( name ) ) return true;
        ...
        return {
            Program () {
                globalScope = context.sourceCode.scopeManager.globalScope;
            },
            ...
            Identifier ( node ) {
                ...
                const name = node.name,
                    nameIsUnderscored = isUnderscored( name.replaceAll( /^_+|_+$/gv, "" ) ),
